                    ...
                    <div class="md:flex h-full">
                        ...
                        <div class="md:w-1/3 p-10 bg-gradient-to-b from-blue-50 to-white flex flex-col items-center">
                            <div class="relative w-full aspect-square mb-8 group overflow-hidden rounded-3xl shadow-2xl">
                                <img :src="'{{ asset('storage') }}/' + selectedTeacher?.image" 
                                     class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 cursor-zoom-in" 
                                     @click="zoomedImageSrc = '{{ asset('storage') }}/' + selectedTeacher?.image; zoomImage = true"
                                     alt="Profile">
                                    ...
                                    <div class="space-y-10">
                                        ...
                                        <div class="bg-blue-50 p-6 rounded-3xl border border-blue-100 flex items-center">
                                            <div class="w-20 h-20 rounded-2xl overflow-hidden shadow-xl mr-6 border-2 border-white">
                                                <img :src="selectedTeacher.teacher_of_groups[0].assistant ? '{{ asset('storage') }}/' + selectedTeacher.teacher_of_groups[0].assistant.image : 'https://ui-avatars.com/api/?name=Assistant'" 
                                        ...
                                        <div>
                                            ...
                                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 max-h-[300px] overflow-y-auto pr-4 custom-scrollbar">
                                                <template x-for="student in selectedTeacher.teacher_of_groups[0].students" :key="student.id">
                                                    <div class="group/child cursor-pointer" @click="zoomedImageSrc = '{{ asset('storage') }}/' + student.image; zoomImage = true">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-10">
                <div class="bg-white p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all border border-gray-100 text-center">
                    ...
                    <div class="text-5xl font-black text-blue-900 mb-2">{{ $stats->asosiy }}+</div>
                    <div class="text-gray-400 font-black uppercase tracking-widest text-[10px]">{{ __('messages.primary_teacher') }}</div>
                </div>
                <!-- ... other stats ... -->
                <div class="bg-white p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all border border-gray-100 text-center">
                    <div class="w-20 h-20 bg-blue-100 text-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner">
                    ...
                    <div class="text-5xl font-black text-blue-900 mb-2">{{ $stats->ilmiy }}+</div>
                    <div class="text-gray-400 font-black uppercase tracking-widest text-[10px]">{{ __('messages.academic_degree') }}</div>
                </div>
                <div class="bg-white p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all border border-gray-100 text-center">
                    <div class="w-20 h-20 bg-blue-100 text-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner">
                ...
                <div class="bg-white p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all border border-gray-100 text-center">
                    ...
                    <div class="text-5xl font-black text-blue-900 mb-2">{{ $stats->tashqi }}</div>
                    <div class="text-gray-400 font-black uppercase tracking-widest text-[10px]">{{ __('messages.external_teacher') }}</div>
                </div>
            </div>
        </div>
    </section>
