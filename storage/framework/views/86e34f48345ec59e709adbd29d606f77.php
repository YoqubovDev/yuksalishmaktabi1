...
<?php if($hasMenu || ($slot ?? false)): ?>
<aside <?php echo e($attributes->merge(['class' => 'layout-second-sidebar'])); ?>
...
<?php endif; ?>
    ...
    <?php if($collapsed): ?>
        <div <?php echo e($collapseAttributes->merge(['class' => 'layout-collapse'])); ?>>
            <button
                type="button"
                @click.prevent="minimizedMenu = ! minimizedMenu"
                class="layout-collapse-btn btn"
                title="<?php echo e($translates['collapse_menu'] ?? 'Collapse sidebar'); ?>"
            >
...
<?php endif; ?>
<?php $component->withAttributes(['x-show' => '!minimizedMenu']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/shehroz/Projects/example-app/vendor/moonshine/moonshine/src/UI/resources/views/components/layout/second-bar.blade.php ENDPATH**/ ?>