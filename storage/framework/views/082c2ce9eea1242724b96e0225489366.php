...
<div <?php echo e($attributes->class(['box space-elements', 'box--dark' => $dark])); ?>>
    <?php if($label || $icon->isNotEmpty()): ?> <h2 class="box-title"><?php echo e($icon ?? ''); ?><?php echo e($label ?? ''); ?></h2> <?php endif; ?>
...
<?php /**PATH /home/shehroz/Projects/example-app/vendor/moonshine/moonshine/src/Laravel/src/Providers/../../../UI/resources/views/components/layout/box.blade.php ENDPATH**/ ?>