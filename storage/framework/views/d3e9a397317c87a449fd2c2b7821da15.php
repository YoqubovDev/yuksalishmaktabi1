    ...
    <?php else: ?>
        ...
        <?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(isset($optionValue['values'])): ?>
                <optgroup <?php echo e($optionValue['attributes']?->merge(['label' => $optionValue['label']]) ?? ''); ?>>
            ...
            <?php else: ?>
                <option <?php if($optionValue['selected'] || $attributes->get('value', '') == $optionValue['value']): echo 'selected'; endif; ?>
                        ...
                        <?php echo e($optionValue['attributes'] ?? ''); ?>
...
<?php /**PATH /home/shehroz/Projects/example-app/vendor/moonshine/moonshine/src/Laravel/src/Providers/../../../UI/resources/views/components/form/select.blade.php ENDPATH**/ ?>