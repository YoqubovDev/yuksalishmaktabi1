...
<?php endif; ?>
  ...
  <section class="py-16 bg-gray-50" x-data="{ 
      ...
      <div class="container mx-auto px-4">
          ...
          <?php $__currentLoopData = $groupedHomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $categoryHomes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="mb-12">
              <h4 class="text-2xl font-bold text-blue-800 mb-6 border-b-2 border-blue-200 inline-block pb-2"><?php echo e($categoryName); ?></h4>

              <div class="swiper teacherSwiper">
                  <div class="swiper-wrapper">
                      <?php $__currentLoopData = $categoryHomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $home): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php
                          ...
                          <div class="swiper-slide py-4">
                              <div @click="selectedTeacher = { 
                                      name: '<?php echo e(addslashes($home->name)); ?>', 
                                      subject: '<?php echo e(addslashes($home->subject)); ?>', 
                                      bio: '<?php echo e(str_replace(["\r", "\n"], ['\r', '\n'], addslashes($home->bio))); ?>', 
                                      image: '<?php echo e(asset('storage/' . $home->image)); ?>',
                                      group: <?php echo e($groupJson); ?>
