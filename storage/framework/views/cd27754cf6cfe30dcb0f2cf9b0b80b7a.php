                         ...
                         <?php $__env->slot('tbody', null, []); ?> 
                            <?php if($rows->isNotEmpty()): ?>
                                <?php for($i = 0; $i < $rows->count(); $i++): ?>
                                    <tr>
                                        <?php $__currentLoopData = $rows[0]->getCells(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td>
                                ...
                                <?php endfor; ?>
                            <?php elseif($headRows->isNotEmpty()): ?>
                                <?php for($i = 0; $i < 3; $i++): ?>
                                    <tr>
                                        <?php $__currentLoopData = $headRows[0]->getCells(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td>
                                                <div class="skeleton"></div>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/shehroz/Projects/example-app/vendor/moonshine/moonshine/src/Laravel/src/Providers/../../../UI/resources/views/components/table/builder.blade.php ENDPATH**/ ?>