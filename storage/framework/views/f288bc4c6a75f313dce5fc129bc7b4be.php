...
<button @click.prevent="copy('<?php echo e($value); ?>')"
...
<?php $component = MoonShine\UI\Components\Icon::resolve(['icon' => 'clipboard','size' => '4'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /home/shehroz/Projects/example-app/vendor/moonshine/moonshine/src/UI/resources/views/components/form/input-extensions/copy.blade.php ENDPATH**/ ?>