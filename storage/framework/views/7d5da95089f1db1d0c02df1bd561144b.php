...
<?php $component = MoonShine\UI\Components\Icon::resolve(['icon' => 'document'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<h5 class="dropzone-file-name">
    <a
        <?php if($download ?? false): ?> download href="<?php echo e($value); ?>" <?php endif; ?>
    >
        <?php echo e($filename ?? $value); ?>

    </a>
</h5>
<?php /**PATH /home/shehroz/Projects/example-app/vendor/moonshine/moonshine/src/UI/resources/views/components/file.blade.php ENDPATH**/ ?>