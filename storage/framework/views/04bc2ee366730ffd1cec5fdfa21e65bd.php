...
<div x-data="dropdown"
     ...
     data-dropdown-strategy="<?php echo e($strategy); ?>"
...
>
    ...
    <div <?php echo e($attributes->merge(['class' => 'dropdown-body'])); ?>>
        <?php if($title ?? false): ?>
            <div class="dropdown-heading"><?php echo e($title); ?></div>
        <?php endif; ?>
...
<?php /**PATH /home/shehroz/Projects/example-app/vendor/moonshine/moonshine/src/Laravel/src/Providers/../../../UI/resources/views/components/dropdown.blade.php ENDPATH**/ ?>