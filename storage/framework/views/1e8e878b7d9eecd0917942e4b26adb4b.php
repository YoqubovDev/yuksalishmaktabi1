                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div class="contact-card bg-gray-50 rounded-lg p-6 shadow-sm">
                                ...
                                <p class="text-gray-700"><?php echo e($contact->address ?? 'Ma\'lumot kiritilmagan'); ?></p>
                            </div>
                            ...
                            <div class="contact-card bg-gray-50 rounded-lg p-6 shadow-sm">
                                ...
                                <?php if($contact->phone): ?>
                                    <a href="tel:+998<?php echo e($contact->phone); ?>" class="text-gray-700 hover:text-blue-600 transition">
                                        +998 <?php echo e($contact->phone); ?>
                                ...
                                <?php if($contact->fax): ?>
                                    <p class="text-gray-600 text-sm mt-2">Fax: +998 <?php echo e($contact->fax); ?></p>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="contact-card bg-gray-50 rounded-lg p-6 shadow-sm">
                                ...
                                <?php if($contact->email): ?>
                                    <a href="mailto:<?php echo e($contact->email); ?>" class="text-blue-600 hover:underline break-all">
                            ...
                            <div class="contact-card bg-gray-50 rounded-lg p-6 shadow-sm">
                                ...
                                <p class="text-gray-700">
                                    Dushanba - Shanba<br>
                                    <?php echo e($contact->work_time ?? 'Ma\'lumot kiritilmagan'); ?>

                                </p>
                                <?php if($contact->lunch_time): ?>
                                    <p class="text-gray-600 text-sm mt-2">
                                        <i class="fas fa-utensils mr-1"></i>Tushlik: <?php echo e($contact->lunch_time); ?>
                        ...
                        <!-- Transport Card -->
                        <?php if($contact->bus || $contact->marshrut): ?>
                            <div class="contact-card bg-gray-50 rounded-lg p-6 shadow-sm mt-6">
                                ...
                                <div class="text-gray-700 space-y-1">
                                    <?php if($contact->bus): ?>
                                        <p><i class="fas fa-bus text-blue-500 mr-2"></i>Avtobus: <?php echo e($contact->bus); ?></p>
                                    <?php endif; ?>
                                    <?php if($contact->marshrut): ?>
                                        <p><i class="fas fa-route text-blue-500 mr-2"></i>Marshut: <?php echo e($contact->marshrut); ?></p>
                                    <?php endif; ?>
                                    <?php if($contact->stop): ?>
                                        <p><i class="fas fa-map-pin text-blue-500 mr-2"></i>Bekat: <?php echo e($contact->stop); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <?php if($contact->telegram): ?>
                                    <a href="<?php echo e(str_starts_with($contact->telegram, 'http') ? $contact->telegram : 'https://t.me/' . $contact->telegram); ?>" 
                                       target="_blank" 
                                ...
                                <?php if($contact->facebook): ?>
                                    <a href="<?php echo e(str_starts_with($contact->facebook, 'http') ? $contact->facebook : 'https://facebook.com/' . $contact->facebook); ?>" 
                                       target="_blank" 
                                ...
                                <?php if($contact->youtube): ?>
                                    <a href="<?php echo e(str_starts_with($contact->youtube, 'http') ? $contact->youtube : 'https://youtube.com/@' . $contact->youtube); ?>" 
                                       target="_blank" 
                                ...
                                <?php if($contact->instagram): ?>
                                    <a href="<?php echo e(str_starts_with($contact->instagram, 'http') ? $contact->instagram : 'https://instagram.com/' . $contact->instagram); ?>" 
                                       target="_blank" 
                    ...
                    <div>
                            ...
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                                <div class="flex items-center">
                                    <div class="bg-white shadow-md rounded-lg px-4 py-2 flex items-center mr-4">
                                        ...
                                        <span class="font-bold text-lg"><?php echo e($contact->rating ?? '5'); ?></span>
                                    </div>
                                    <div>
                                ...
                                <?php if($contact->map_link): ?>
                                    <a href="<?php echo e($contact->map_link); ?>" 
                                       target="_blank" 
                        ...
                        <div class="mt-6 bg-blue-600 text-white rounded-lg p-6 shadow-lg">
                            ...
                            <div class="space-y-3">
                                <?php if($contact->phone): ?>
                                    <a href="tel:+998<?php echo e($contact->phone); ?>" class="flex items-center hover:bg-blue-700 p-2 rounded transition">
                                        <i class="fas fa-phone-alt mr-3"></i>
                                        <span>+998 <?php echo e($contact->phone); ?></span>
                                    </a>
                                <?php endif; ?>
                                <?php if($contact->email): ?>
                                    <a href="mailto:<?php echo e($contact->email); ?>" class="flex items-center hover:bg-blue-700 p-2 rounded transition break-all">
...
</html><?php /**PATH /home/shehroz/Projects/example-app/resources/views/aloqa.blade.php ENDPATH**/ ?>