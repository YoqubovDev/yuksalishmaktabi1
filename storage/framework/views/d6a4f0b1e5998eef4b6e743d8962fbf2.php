...
<div <?php echo e($attributes->merge(['class' => 'flex items-center gap-x-1'])); ?>>
    <?php for($star = $min; $star <= $max; $star++): ?>
...
<?php $component = MoonShine\UI\Components\Icon::resolve(['icon' => ($star <= $value) ? 's.star' : 'star','size' => '4'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(($star <= $value) ? 'text-primary' : 'text-secondary')]); ?>
...
<?php /**PATH /home/shehroz/Projects/example-app/vendor/moonshine/moonshine/src/UI/resources/views/components/rating.blade.php ENDPATH**/ ?>