...
<body class="bg-gray-50">
    ...
    <section class="py-16 bg-gradient-to-b from-blue-900 to-blue-800">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-white mb-4"><?php echo e(__('messages.our_teachers')); ?></h2>
                <div class="w-24 h-1 bg-yellow-400 mx-auto mb-6"></div>
                <p class="text-blue-100 max-w-2xl mx-auto"><?php echo e(__('messages.teachers_desc')); ?></p>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <h3 class="text-3xl font-bold text-blue-900 mb-10 text-center"><?php echo e(__('messages.teacher_team')); ?></h3>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center">
                    ...
                    <div class="text-gray-600"><?php echo e(__('messages.primary_teacher')); ?></div>
                </div>
                <div class="text-center">
                    <div class="text-5xl font-bold text-blue-900 mb-2"><?php echo e($stats->ilmiy); ?>+</div>
                    <div class="text-gray-600"><?php echo e(__('messages.academic_degree')); ?></div>
                </div>
                <div class="text-center">
                    <div class="text-5xl font-bold text-blue-900 mb-2"><?php echo e($stats->kutator); ?>+</div>
                    <div class="text-gray-600"><?php echo e(__('messages.curator_teacher')); ?></div>
                </div>
                <div class="text-center">
                    <div class="text-5xl font-bold text-blue-900 mb-2"><?php echo e($stats->tashqi); ?></div>
                    <div class="text-gray-600"><?php echo e(__('messages.external_teacher')); ?></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-blue-900 mb-4"><?php echo e(__('messages.departments')); ?></h2>
