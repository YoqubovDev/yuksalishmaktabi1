        ...
        <div class="px-4 md:px-8 max-w-[1600px] mx-auto">
            <div class="header-content">
                ...
                <nav id="mainNav" class="main-nav">
                    <ul>
                        <li><a href="<?php echo e(route('home')); ?>" class="<?php echo e(request()->routeIs('home') ? 'active-link' : ''); ?>"><?php echo e(__('messages.home')); ?></a></li>
                        <li><a href="<?php echo e(route('about')); ?>" class="<?php echo e(request()->routeIs('about') ? 'active-link' : ''); ?>"><?php echo e(__('messages.about')); ?></a></li>
                        ...
                        <li class="lang-container">
                            <a href="<?php echo e(route('lang.switch', 'uz')); ?>" 
                               class="lang-btn <?php echo e(app()->getLocale() == 'uz' ? 'active-lang' : ''); ?>">
                                UZ
                            </a>
                            <a href="<?php echo e(route('lang.switch', 'ru')); ?>" 
                               class="lang-btn <?php echo e(app()->getLocale() == 'ru' ? 'active-lang' : ''); ?>">
                                RU
                            </a>
                        </li>
                    </ul>
...
<?php /**PATH /home/shehroz/Projects/example-app/resources/views/components/header.blade.php ENDPATH**/ ?>